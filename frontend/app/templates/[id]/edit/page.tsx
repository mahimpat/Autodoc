...
export default function EditTemplatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE}/templates/${originalTemplate.id}`, {
        method: 'PUT',
        headers: {
      ...
      if (response.ok) {
        router.push(`/templates/${originalTemplate.id}`)
      } else {
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-100/40 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              <Link href={`/templates/${originalTemplate.id}`}>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-1">
                  Update your template configuration and structure
                </p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update the template name, description and categorization
                    </CardDescription>
                  </CardHeader>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>
                          Update the sections and content flow
                        </CardDescription>
                      </div>
                      <Button
                        type="button"
